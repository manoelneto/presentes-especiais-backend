...
ActiveRecord::Schema.define(version: 20151230022122) do
  ...
  create_table "spree_personalization_themes", force: :cascade do |t|
    t.integer  "spree_personalization_id"
    t.integer  "spree_theme_id"
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end

  add_index "spree_personalization_themes", ["spree_personalization_id"], name: "index_spree_personalization_themes_on_spree_personalization_id", using: :btree
  add_index "spree_personalization_themes", ["spree_theme_id"], name: "index_spree_personalization_themes_on_spree_theme_id", using: :btree
  ...
  add_index "spree_personalizations", ["spree_product_id"], name: "index_spree_personalizations_on_spree_product_id", using: :btree
  ...
  add_index "spree_products", ["spree_category_id"], name: "index_spree_products_on_spree_category_id", using: :btree
  ...
  add_index "spree_themes", ["spree_product_id"], name: "index_spree_themes_on_spree_product_id", using: :btree
